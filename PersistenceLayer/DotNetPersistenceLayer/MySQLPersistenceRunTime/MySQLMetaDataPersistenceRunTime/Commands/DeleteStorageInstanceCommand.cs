...
namespace OOAdvantech.MySQLMetaDataPersistenceRunTime.Commands
{
    ...
    public class DeleteStorageInstanceCommand : OOAdvantech.PersistenceLayerRunTime.Commands.DeleteStorageInstanceCommand
    {
        ...
        public override void Execute()
        {
            ...
            string deleteStatement =string.Format( "DELETE FROM {0}.ObjectBLOBS WHERE(ID=@OID)",StorageInstanceForDeletion.ObjectStorage.StorageMetaData.StorageName);
            ...
            OIDParameter.Value = StorageInstanceForDeletion.PersistentObjectID;
