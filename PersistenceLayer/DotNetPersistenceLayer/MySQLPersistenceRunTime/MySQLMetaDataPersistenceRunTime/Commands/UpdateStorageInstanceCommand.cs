    ...
    public class UpdateStorageInstanceCommand : PersistenceLayerRunTime.Commands.UpdateStorageInstanceCommand
    {
        ...
        public override void Execute()
        {
            ...
            if (FromNewCommand)
            {
                ...
                string insertStatement =string.Format("INSERT INTO {0}.ObjectBLOBS (ID,ClassBLOBSID,ObjectData) Values(@ID,@ClassBLOBSID,@ObjectData)",UpdatedStorageInstanceRef.ObjectStorage.StorageMetaData.StorageName);
                ...
                insertSqlCommand.Parameters["@ID"].Value = UpdatedStorageInstanceRef.PersistentObjectID;
            ...
            else
            {
                ...
                OIDParameter.Value = UpdatedStorageInstanceRef.PersistentObjectID;
                System.IO.MemoryStream memoryStream = new System.IO.MemoryStream();
                (UpdatedStorageInstanceRef as RDBMSMetaDataPersistenceRunTime.StorageInstanceRef).SaveObjectState(memoryStream);
