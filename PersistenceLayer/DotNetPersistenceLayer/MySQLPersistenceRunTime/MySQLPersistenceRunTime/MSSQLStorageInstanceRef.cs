namespace OOAdvantech.MySQLPersistenceRunTime
{
    ...
    /// <MetaDataID>{d40ea2fe-6057-48d0-89da-0ee1de1fd01c}</MetaDataID>
    public class StorageInstanceRef : RDBMSPersistenceRunTime.StorageInstanceRef
	{
	
		public StorageInstanceRef (object memoryInstance,ObjectStorage activeStorageSession,object objectID):base(memoryInstance,activeStorageSession,objectID)
		{
		}
