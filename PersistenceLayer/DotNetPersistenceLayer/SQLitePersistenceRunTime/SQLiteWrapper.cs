    ...
    namespace SQLiteWrapper
    {
        ...
        /// </summary>
        /// <MetaDataID>{372fbbe5-9825-436b-a3e1-4a7c48faaeae}</MetaDataID>
        public class SQLiteBase
        {
            ...
            [DllImport("sqlite3")]
            public static extern int sqlite3_open(IntPtr fileName, out IntPtr database);

            [DllImport("sqlite3")]
            public static extern int sqlite3_close(IntPtr database);

            [DllImport("sqlite3")]
            public static extern int sqlite3_exec(IntPtr database, IntPtr query, IntPtr callback, IntPtr arguments, out IntPtr error);

            [DllImport("sqlite3")]
            public static extern IntPtr sqlite3_errmsg(IntPtr database);

            [DllImport("sqlite3")]
            public static extern int sqlite3_prepare_v2(IntPtr database, IntPtr query, int length, out IntPtr statement, out IntPtr tail);
            ...
            [DllImport("sqlite3")]
            public static extern IntPtr sqlite3_column_name(IntPtr statement, int columnNumber);

            [DllImport("sqlite3")]
            public static extern int sqlite3_column_type(IntPtr statement, int columnNumber);

            [DllImport("sqlite3")]
            public static extern int sqlite3_column_int(IntPtr statement, int columnNumber);

            [DllImport("sqlite3")]
            public static extern double sqlite3_column_double(IntPtr statement, int columnNumber);

            [DllImport("sqlite3")]
            public static extern IntPtr sqlite3_column_text(IntPtr statement, int columnNumber);

            [DllImport("sqlite3")]
            public static extern IntPtr sqlite3_column_blob(IntPtr statement, int columnNumber);

            [DllImport("sqlite3")]
            public static extern IntPtr sqlite3_column_table_name(IntPtr statement, int columnNumber);

            [DllImport("sqlite3")]
            public static extern int sqlite3_finalize(IntPtr handle);

            // SQLite constants 
            public const int SQL_OK = 0;
            public const int SQL_ROW = 100;
            public const int SQL_DONE = 101;
            ...
            public static byte[] PointerToBlob(IntPtr ptr)
            {
            ...
            static int GetPointerLenght(IntPtr ptr)
            {
                if (ptr == IntPtr.Zero)
                    return 0;
                return lstrlen(ptr);
