...
namespace OOAdvantech.RDBMSPersistenceRunTime.Commands
{
    ...
    public class NewStorageInstanceCommand : PersistenceLayerRunTime.Commands.NewStorageInstanceCommand
    {
        ...
        public override void Execute()
        {
            ...
            {
                OOAdvantech.RDBMSPersistenceRunTime.ObjectID objectID = new OOAdvantech.RDBMSPersistenceRunTime.ObjectID(Guid.NewGuid(), 0);
                ...
                Commands.TransferNewInstancesMassivelly.CurrentTransferNewInstancesMassivelly.NewStorageInstance(OnFlyStorageInstance, null);
