    ...
    public  class StorageInstanceRef : PersistenceLayerRunTime.StorageInstanceRef
    {
            ...
            foreach (ValueOfAttribute valueOfAttribute in GetPersistentAttributeMetaData(member.Type as DotNetMetaDataRepository.Structure, valueTypePath, member.Name))
            {
...
#endif
                {
                    ...
                    if (Value is System.DBNull)
                        SetAttributeValue(ref obj, new ValueOfAttribute(valueOfAttribute.Attribute, valueOfAttribute.IsMultilingual, valueOfAttribute.FieldInfo, valueOfAttribute.FastFieldAccessor, null, valueOfAttribute.ValueTypePath, valueOfAttribute.Path, valueOfAttribute.Culture), member.Type as DotNetMetaDataRepository.Structure, 0, out valueSetted);
                    else
                        SetAttributeValue(ref obj, new ValueOfAttribute(valueOfAttribute.Attribute, valueOfAttribute.IsMultilingual, valueOfAttribute.FieldInfo, valueOfAttribute.FastFieldAccessor, Value, valueOfAttribute.ValueTypePath, valueOfAttribute.Path,valueOfAttribute.Culture), member.Type as DotNetMetaDataRepository.Structure, 0, out valueSetted);
                }
            }
        ...
        public void LoadObjectState(string columnsNamePreffix)
        {
            ...
            foreach (ValueOfAttribute valueOfAttribute in GetPersistentAttributeMetaData())
            {
                ...
                object Value = DbDataRecord[metaObjectsColumnsIndices.AttributeIndices[rdbmsAttribute.Identity][valueOfAttribute.PathIdentity]];
