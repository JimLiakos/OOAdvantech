...
namespace OOAdvantech.CommonEventHandler
{
    ...
    /// </summary>
    /// <MetaDataID>{7487a562-d9ce-4f86-a377-0570b0061965}</MetaDataID>
	public class EventHandlerTypeEmitter
	{
		...
		public Type GetEventHandlerType(EventInfo Info) 
		{
            lock (handlerTypes)
            {
                string handlerName = Info.DeclaringType.Assembly.FullName + "." + Info.DeclaringType.FullName + "." + Info.Name;
