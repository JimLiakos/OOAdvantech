...
namespace OOAdvantech.Remoting
{
    ...
    public class EventConsumerProxy
    {
        ...
        public EventConsumerProxy(ExtObjectUri eventPublisherUri, MarshalByRefObject eventPublisherObject, System.Reflection.EventInfo eventInfo, ServerSessionPart serverSessionPart, IRemoteEventHandler clientSessionPart)
        {
            ...
            Type transparentProxyType = eventInfo.DeclaringType.GetMetaData().Assembly.GetType(eventInfo.DeclaringType.Namespace + ".Proxies.CNSPr_" + eventInfo.DeclaringType.Name + "_" + eventInfo.Name);

            var ctor = transparentProxyType.GetMetaData().GetConstructor(System.PCL.Reflection.BindingFlags.Public | System.PCL.Reflection.BindingFlags.Instance, new Type[0] );
