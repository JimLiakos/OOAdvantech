...
namespace OOAdvantech.WindowsAzureTablesPersistenceRunTime.AzureTableMetaDataPersistenceRunTime
{
    ...
    public class ObjectStorage : PersistenceLayerRunTime.ObjectStorage
    {
        ...
        public ObjectStorage(string storageName, string storageLocation, bool newStorage, Azure.Data.Tables.TableServiceClient tablesAccount)
        {
            //Account = account;
            TablesAccount = tablesAccount;
            _StorageMetaData = new Storage(storageName, storageLocation, "OOAdvantech.WindowsAzureTablesPersistenceRunTime.AzureTableMetaDataPersistenceRunTime.StorageProvider", newStorage,  tablesAccount);
