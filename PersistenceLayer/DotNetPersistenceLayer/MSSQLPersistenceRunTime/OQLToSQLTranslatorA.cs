...
{
	internal class OQLStatementa
	{
		/// <MetaDataID>{36C8C243-EF4F-4ECF-A4E7-5068FFE6C192}</MetaDataID>
		public OQLStatementa(OOAdvantech.Collections.Map parameters)
		{
		...
		/// <MetaDataID>{7D5DF044-6BF7-46B8-97C1-C272EDC01C65}</MetaDataID>
		...
		/// <MetaDataID>{3A1F9D11-391F-49DE-B2F8-1AA7378F768F}</MetaDataID>
		...
		/// <MetaDataID>{CA5E4F24-2879-42CB-AA92-4D2824471877}</MetaDataID>
