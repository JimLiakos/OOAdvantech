...
namespace FacadeProxiesGenerator
{
    ...
    class Sample
    {
        ...
        public Sample(System.Type type)
        {
            targetUnit = new CodeCompileUnit();
        ...
        public void AddFields()
        {
            ...
            proxyField.Type =
                new CodeTypeReference(typeof(OOAdvantech.Remoting.RestApi.Proxy));
        ...
        public void AddProxyConstructor()
        {
            // Declare the constructor
            CodeConstructor constructor = new CodeConstructor();
            constructor.Attributes =
            ...
            CodeFieldReferenceExpression widthReference =
                new CodeFieldReferenceExpression(
                new CodeThisReferenceExpression(), "Poxy");
            constructor.Statements.Add(new CodeAssignStatement(widthReference,
                new CodeArgumentReferenceExpression("proxy")));
