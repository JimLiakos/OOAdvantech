namespace OOAdvantech.PersistenceLayer
{
    ...
    {
        event ObjectStorageResolveHandler ObjectStorageResolve;
        event ObjectStorageLoadeHandler ObjectStorageLoad;
        ...
        ObjectStorage NewStorage(Storage storageMetadata, string storageName, string storageLocation, string storageType, bool InProcess, string userName = "", string password = "");
        /// <summary>Create a storage access session. </summary>
        /// <param name="storageName">The name of Object Storage </param>
        /// <param name="storageLocation">This string used to specify the location of new storage. Maybe is a SQL server name or URL (Uniform Resource Locator). 
        /// If it is null then the PersistencyContext will look at Persistence Layer repository. </param>
        ...
        ObjectStorage OpenStorage(string storageName, string storageLocation, string storageType, string userName = "", string password = "");
        ...
        /// <param name="storageType">This parameter used to specify the type of new storage. Actual is the full name of Storage Provider for example MSSQLRunTime. MSSQLStorageProvider. </param>
        /// <MetaDataID>{F97962CD-EB7A-41BA-8890-202B81F95C05}</MetaDataID>
        ObjectStorage NewLogicalStorage(string storageName, string storageLocation, string storageType, string logicalStorageName, bool InProcess);
        ...
        ObjectStorage NewStorage(Storage storageMetadata, string storageName, object rawStorageData, string storageType);
        ...
        ObjectStorage OpenStorage(string storageName, object rawStorageData, string storageType);

        /// <MetaDataID>{64945209-A20D-479F-8D3C-BA8B9CB0BB5A}</MetaDataID>
        ObjectStorage GetStorageOfObject(object memoryInstance);
        ...
        void GetStorageInstancePersistentObjectID(object _object, out ObjectID objectID, out string storageIdentity);

        /// <MetaDataID>{9551ef72-926c-45ce-a5c5-d1917552eaa6}</MetaDataID>
        void GetStorageInstanceObjectID(object _object, out ObjectID transientObjectID, out string storageIdentity);
