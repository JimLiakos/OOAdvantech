namespace OOAdvantech.MSSQLFastPersistenceRunTime.DataObjects
{
    ...
    public class ClassBLOB
    {
        ...
        public void Serialize(byte[] byteStream, int offset, out int nextAvailablePos)
        {
            ...
            BinaryFormatter.BinaryFormatter.Serialize(type.Assembly.FullName, byteStream, offset, ref offset);
        ...
        public ClassBLOB(byte[] byteStream, int offset)
        {
            ...
            if (Storage.BackwardCompatibilities.ContainsKey(AssemblyFullName))
