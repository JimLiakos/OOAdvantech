...
namespace GoldParser
{
    ...
    /// </summary>
    /// <MetaDataID>{6f21b743-dcca-4b5e-9206-66f58ed6baa9}</MetaDataID>
    internal sealed class GoldParser
	{
		#region Fields
        ...
        internal char[]    ParsingExpression;
		...
		private const int  MinimumLRStackSize = 1356;   // Minimum size of reduction stack.
		...
		public GoldParser(TextReader textReader, Grammar grammar)
		{
			if (textReader == null)
			{
            ...
            string parsingExpression= textReader.ReadToEnd();
            ParsingExpression = new char[parsingExpression.Length];
            parsingExpression.CopyTo(0, ParsingExpression, 0, parsingExpression.Length);
            textReader = new StringReader(parsingExpression);
		...
		private int ReadBuffer()
		{
            ...
            //Array.Copy(m_buffer, ParsingExpression, result);
