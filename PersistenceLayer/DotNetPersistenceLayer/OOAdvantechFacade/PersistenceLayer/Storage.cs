...
namespace OOAdvantech.PersistenceLayer
{
    ...
    public interface Storage
    {
        ...
        void RegisterComponent(string assemblyFullName, System.Xml.XmlDocument mappingData);
        /// <MetaDataID>{e16fed5d-221a-4506-93ba-c091add5eeac}</MetaDataID>
        void RegisterComponent(string[] assembliesFullNames, System.Collections.Generic.Dictionary<string, System.Xml.XmlDocument> assembliesMappingData);
