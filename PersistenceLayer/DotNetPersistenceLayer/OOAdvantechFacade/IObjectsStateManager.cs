...
namespace OOAdvantech.Transactions
{
    ...
    /// <MetaDataID>{28bd6c09-1480-4170-b4d2-3ca2316f8e93}</MetaDataID>
    ...
    public delegate void ActionRequest(ITransactionEnlistment transactionEnlistment);
    ...
    public interface ObjectsStateManager
    {
