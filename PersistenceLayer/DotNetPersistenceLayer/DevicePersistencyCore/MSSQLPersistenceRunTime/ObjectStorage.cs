...
namespace OOAdvantech.MSSQLPersistenceRunTime
{
	...
	public class Storage : RDBMSMetaDataRepository.Storage
	{
        ...
        MSSQLFastPersistenceRunTime.ObjectStorage _MetadataStorage = null;
       internal  MSSQLFastPersistenceRunTime.ObjectStorage MetadataStorage
        {
            get
            {
                if(_MetadataStorage ==null)
                    _MetadataStorage = PersistenceLayer.ObjectStorage.GetStorageOfObject(this.Properties) as MSSQLFastPersistenceRunTime.ObjectStorage;
