...
using Android.Media;
using OOAdvantech.AudioManager.Droid;
using OOAdvantech.AudioManager;
using Xamarin.Forms;

[assembly: Dependency(typeof(DroidAudioManager))]
namespace OOAdvantech.AudioManager.Droid
{
    /// <MetaDataID>{9c59d863-f338-4c36-945e-f83edf739903}</MetaDataID>
    class DroidAudioManager : OOAdvantech.AudioManager.IAudioManager
    {
