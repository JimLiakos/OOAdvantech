...
namespace OOAdvantech.Remoting.RestApi.Proxies
{
    ...
    /// <MetaDataID>{998ebe6d-0d90-41a6-abc5-8f5d8a8b9d3b}</MetaDataID>
    ...
    /// <MetaDataID>{cf0b5e39-71d4-49f7-b197-db05a5a83323}</MetaDataID>
...
namespace OOAdvantech.Authentication.Proxies
{
    ...
    /// <MetaDataID>{afa17009-3647-4557-94e8-f8184f6b7437}</MetaDataID>
    ...
    /// <MetaDataID>{e48281b0-5745-4dd6-a2ec-5d3a8879f26a}</MetaDataID>
    ...
    /// <MetaDataID>{9b3a1ad0-05e4-4184-a785-1726bf3d591c}</MetaDataID>
