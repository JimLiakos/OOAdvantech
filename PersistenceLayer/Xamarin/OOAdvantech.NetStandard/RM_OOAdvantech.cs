...
namespace OOAdvantech.Remoting.Proxies
{
    ...
    /// <MetaDataID>{15eaaa73-7c92-4642-823e-a5b11df0851f}</MetaDataID>
...
namespace OOAdvantech.Remoting.RestApi.Proxies
{
    ...
    /// <MetaDataID>{9bd692db-1223-43a9-a22f-5672937d4bfc}</MetaDataID>
...
namespace OOAdvantech.Authentication.Proxies
{
    ...
    /// <MetaDataID>{b3080023-5518-432a-8c94-762ede2edbba}</MetaDataID>
    ...
    /// <MetaDataID>{c5a02ef8-7a2a-4ab9-92d8-0604d6ace69d}</MetaDataID>
    ...
    /// <MetaDataID>{9f798e45-ba07-491f-aba9-731dfa61550b}</MetaDataID>
