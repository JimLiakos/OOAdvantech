...
namespace VivaWalletPos
{
    public class VivaWalletPos
    {
        ...
        Task<CardLink.PaymentData> SalesTask;

        int Sessionid = 1;
        public CardLink.PaymentData Sale(double amount)
        {
#if DEBUG
            amount = 0.01;
#endif
            ...
            SalesTask = Task<CardLink.PaymentData>.Run(() =>
            {
                ...
                try
                {
                    ...
                    CardLink.PaymentData paymentData = null;
                    try
                    {
                        ...
                        if (responseData.IndexOf("0014|810|00|") == 0)
                        {
                            ...
                            {
                                paymentData = new CardLink.PaymentData();
                ...
                return default(CardLink.PaymentData);
