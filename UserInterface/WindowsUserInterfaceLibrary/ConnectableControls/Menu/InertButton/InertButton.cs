...
namespace ConnectableControls.Menus.Controls
{
    
	/// <MetaDataID>{7F227CA8-8E36-44E3-9ADD-C9F31C4B89C3}</MetaDataID>
    ...
    public class InertButton : Control
    {
		...
		/// <MetaDataID>{91C3F6B3-9CC0-4F9A-AD36-19AE9963F542}</MetaDataID>
        public InertButton()
        {
            InternalConstruct(null, -1, -1, null);
        }

		/// <MetaDataID>{6187FAC8-FF80-4CB1-9EEE-EC129A6EEB64}</MetaDataID>
        public InertButton(ImageList imageList, int imageIndexEnabled)
        {
            InternalConstruct(imageList, imageIndexEnabled, -1, null);
        }

		/// <MetaDataID>{971E1839-6A93-4187-BEC4-C30E3DFF3106}</MetaDataID>
		...
		/// <MetaDataID>{7EE84EFE-B612-4EA6-AB02-38BA7DFA8113}</MetaDataID>
		...
		/// <MetaDataID>{009B2BE0-9B7F-4B99-AB12-7BA0FE96DFDF}</MetaDataID>
		...
		/// <MetaDataID>{706304A1-8C4F-4DFC-B6D4-7A409190DCD9}</MetaDataID>
		...
		/// <MetaDataID>{AA8F1E21-960D-47D2-AECE-836556184298}</MetaDataID>
		...
		/// <MetaDataID>{64393F3E-B94F-424B-B9BE-1D2AD320BEF9}</MetaDataID>
		...
		/// <MetaDataID>{8F8AF0E5-56DB-461D-9B72-669DE13C59E7}</MetaDataID>
		...
		/// <MetaDataID>{DEEE487C-DA11-434C-8B82-D6AE6DDCDB03}</MetaDataID>
		...
		/// <MetaDataID>{DC2067FD-B492-4FA7-8725-964D944AA86A}</MetaDataID>
        protected override void OnPaint(PaintEventArgs e)
        {
//			Rectangle rectangle=new Rectangle(0,0,Size.Width,Size.Height);
//			using( Brush backBrush = new LinearGradientBrush(new Point(rectangle.Width,rectangle.Bottom),
//				new Point(rectangle.Width,rectangle.Top),ControlPaint.Dark(this.BackColor),ControlPaint.Light(this.BackColor)))
//			{
            ...
            if (_imageList != null)
            {
                ...
                if (!this.Enabled)
                {
                    ...
                    else
                    {
                        ...
                        if (_imageIndexEnabled != -1)
                        {
                            ...
                            System.Windows.Forms.ControlPaint.DrawImageDisabled(e.Graphics, _imageList.Images[_imageIndexEnabled], 1, 1, this.BackColor);
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    else
                    {
						...
						//image.Save("X:\\lIAKOS.BMP",System.Drawing.Imaging.ImageFormat.Bmp);
                    ...
                    System.Windows.Forms.ControlPaint.DrawBorder(e.Graphics, this.ClientRectangle, 
