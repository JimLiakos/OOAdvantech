...
namespace ConnectableControls.SchedulerControl
{
    ...
    /// </summary>
    /// <MetaDataID>{f5a43cc0-6b60-4503-bea4-6905a57e36f0}</MetaDataID>
    public class CellStyle
    {
        ...
        /// </summary>
        /// <MetaDataID>{A0343072-9632-41FB-82BF-0568B55852C8}</MetaDataID>
        public CellStyle()
        {
        ...
        /// </summary>
        [Category("Appearance"),Description("The foreground color used to display text and graphics in the cell")]
        ...
        /// </summary>
        [Category("Appearance"),Description("The amount of space between the cells border and its contents")]
