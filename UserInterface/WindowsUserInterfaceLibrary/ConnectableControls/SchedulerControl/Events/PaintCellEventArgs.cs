...
namespace ConnectableControls.SchedulerControl.Events
{
    ...
    /// </summary>
    /// <MetaDataID>{18309d60-9097-44eb-8bab-d06e6c141957}</MetaDataID>
    public class PaintCellEventArgs : System.Windows.Forms.PaintEventArgs
    {
        ...
        public PaintCellEventArgs(Graphics g, Rectangle cellRect)
            : this(g, null, null, -1, -1, false, false, false, false, true, cellRect)
        {
        ...
        public PaintCellEventArgs(Graphics g, Cell cell, SchedulerListView table, int row, int column, bool selected, bool focused, bool sorted, bool editable, bool enabled, Rectangle cellRect)
            : base(g, cellRect)
        {
            this.cell = cell;
            this.table = table;
