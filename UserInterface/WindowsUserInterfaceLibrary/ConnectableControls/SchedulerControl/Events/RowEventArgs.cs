...
namespace ConnectableControls.SchedulerControl.Events
{
    ...
    /// </summary>
    /// <MetaDataID>{1701a1b0-c3ba-4da2-be61-34757a2f1541}</MetaDataID>
    public class RowEventArgs : EventArgs
    {
        ...
        /// <MetaDataID>{C7554B6F-EC67-451B-B444-3E803B886A7A}</MetaDataID>
        ...
        /// <MetaDataID>{4EA67243-F0CE-458D-8322-AE4DAE74C2D2}</MetaDataID>
        ...
        /// <param name="cellToIndex">The end index of the affected Cell(s)</param>
        /// <param name="eventType">The type of event</param>
        /// <MetaDataID>{6B27F0EE-38CE-40AF-BCB3-5A4DFC9B2AB3}</MetaDataID>
        ...
        /// <MetaDataID>{B4DAF2BD-F405-4442-8293-BB7B1418A2D6}</MetaDataID>
