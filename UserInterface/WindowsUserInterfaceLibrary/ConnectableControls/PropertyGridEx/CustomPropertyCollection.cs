namespace ConnectableControls
{
    ...
    /// <MetaDataID>{32c090af-49fd-4279-b529-a820328a320d}</MetaDataID>
	[Serializable()]
    public class CustomPropertyCollection : System.Collections.CollectionBase, ICustomTypeDescriptor
	{
        ...
        public CustomProperty this[string index]
        {
            get
            {
                foreach (CustomProperty CustomProp in base.List)
                {
                    if (CustomProp.Name == index)
                        return CustomProp;
                }
                return null;
            }
        ...
        public Control PropertiesOwner;
