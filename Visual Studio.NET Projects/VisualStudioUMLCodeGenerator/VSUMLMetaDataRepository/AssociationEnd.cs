...
namespace OOAdvantech.VSUMLMetaDataRepository
{
    ...
    public class AssociationEnd : OOAdvantech.MetaDataRepository.AssociationEnd, IVSUMLModelItemWrapper
    {
        ...
        internal  IProperty VSUMLAssociationEnd;
            ...
            : base(vsUMLAssociationEnd.Name, specification, roleType)
        {
            ...
            MetaObjectMapper.AddTypeMap(VSUMLAssociationEnd as ModelElement, this);
        ...
        public override void Synchronize(MetaDataRepository.MetaObject originMetaObject)
        {
            ...
            if (VSUMLAssociationEnd == null)
            {
                AssociationEnd roleA = null;// new AssociationEnd(vsUMLRoleAAssociationEnd, roleAClassifier, roleBClassifier, MetaDataRepository.Roles.RoleA, iModel);
                AssociationEnd roleB = null;// new AssociationEnd(vsUMLRoleBAssociationEnd, roleBClassifier, roleAClassifier, MetaDataRepository.Roles.RoleB, iModel);
                ...
                IAssociation vsUMLAssociation = VSUmlModel.CreateAssociation((roleAClassifier as IVSUMLModelItemWrapper).ModelElement as IClassifier,(roleBClassifier as IVSUMLModelItemWrapper).ModelElement as IClassifier);
                ...
                if(!string.IsNullOrWhiteSpace(originAssociationEnd.Association.RoleA.Name))
                    vsUMLRoleAAssociationEnd.Name = originAssociationEnd.Association.RoleA.Name;
                if (!string.IsNullOrWhiteSpace(originAssociationEnd.Association.RoleB.Name))
                    vsUMLRoleBAssociationEnd.Name = originAssociationEnd.Association.RoleB.Name;


                if (_IsRoleA)
                {
                    VSUMLAssociationEnd = vsUMLRoleAAssociationEnd;
                    MetaObjectMapper.AddTypeMap(VSUMLAssociationEnd as ModelElement, this);
                    _Name = originAssociationEnd.Name;
                    roleA = this;
                    SetSpecification(roleBClassifier);
                    roleB = new AssociationEnd(vsUMLRoleBAssociationEnd, roleBClassifier, roleAClassifier, MetaDataRepository.Roles.RoleB, VSUmlModel);
                    _Navigable=originAssociationEnd.Association.RoleA.Navigable;
                    _Multiplicity=originAssociationEnd.Association.RoleA.Multiplicity;
                    roleB.Navigable=originAssociationEnd.Association.RoleB.Navigable;
                    
                }
                else
                {
                    VSUMLAssociationEnd = vsUMLRoleBAssociationEnd;
                    MetaObjectMapper.AddTypeMap(VSUMLAssociationEnd as ModelElement, this);
                    roleB = this;
                    SetSpecification(roleAClassifier);
                    roleA = new AssociationEnd(vsUMLRoleAAssociationEnd, roleAClassifier, roleBClassifier, MetaDataRepository.Roles.RoleA, VSUmlModel);
                    _Navigable=originAssociationEnd.Association.RoleB.Navigable;
                    _Multiplicity=originAssociationEnd.Association.RoleB.Multiplicity;
                    roleA.Navigable=originAssociationEnd.Association.RoleA.Navigable;
                }
                vsUMLRoleAAssociationEnd.SetNavigable(originAssociationEnd.Association.RoleA.Navigable);
                vsUMLRoleBAssociationEnd.SetNavigable(originAssociationEnd.Association.RoleB.Navigable);
                vsUMLRoleAAssociationEnd.SetBounds(originAssociationEnd.Association.RoleA.Multiplicity.ToString());
                vsUMLRoleBAssociationEnd.SetBounds(originAssociationEnd.Association.RoleB.Multiplicity.ToString());
                vsUMLAssociation.Name = originAssociationEnd.Association.Name;

                string metaObjectID = MetaObjectMapper.GetIdentity(originAssociationEnd.Association).ToString();
                (vsUMLAssociation as ModelElement).GetExtensionData().SetPropertyValue("MetaData", "MetaObjectID", metaObjectID);
                _Association = new Association(vsUMLAssociation, roleA, roleB, VSUmlModel, metaObjectID);
