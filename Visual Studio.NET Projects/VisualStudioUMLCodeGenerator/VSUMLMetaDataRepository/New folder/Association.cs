...
namespace OOAdvantech.VSUMLMetaDataRepository
{
    ...
    public class Association : OOAdvantech.MetaDataRepository.Association,IVSUMLModelItemWrapper
    {
        ...
        public Association(IAssociation vsUMLAssociation, AssociationEnd roleA, AssociationEnd roleB, Microsoft.VisualStudio.Uml.AuxiliaryConstructs.IModel iModel)
            : base(vsUMLAssociation.Name, roleA, roleB, (vsUMLAssociation as ModelElement).Id.ToString())
        {
