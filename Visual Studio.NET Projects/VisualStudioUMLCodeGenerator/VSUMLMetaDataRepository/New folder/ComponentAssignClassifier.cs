...
{
    /// <MetaDataID>{0d80134d-1fc8-4edd-bb00-961322d5fdcc}</MetaDataID>
    public class ComponentAssignClassifier
    {
        ...
        public ComponentAssignClassifier(OOAdvantech.MetaDataRepository.Classifier @class,OOAdvantech.VSUMLMetaDataRepository.Component component)
        {
            Classifier=@class;
            Component = component;
        ...
        System.Drawing.Bitmap AssignedImage = Resource.CheckedClass16;
        /// <MetaDataID>{27597112-beb5-457a-908b-93e790ed4bf7}</MetaDataID>
        System.Drawing.Bitmap UnAssignedImage = Resource.Class16;
