...
namespace OOAdvantech.VSUMLMetaDataRepository
{
    ...
    public class MetaObjectMapper
    {
        ...
        public static void AddTypeMap(Microsoft.VisualStudio.Modeling.ModelElement modelElement, MetaDataRepository.MetaObject theMetaObject)
        {
            ...
            if (!MetaobjectMapper.Contains(identity))
                MetaobjectMapper.Add(identity, theMetaObject);
            else if (MetaobjectMapper[identity] != theMetaObject)
        ...
        public static void RemoveType(Microsoft.VisualStudio.Modeling.ModelElement modelElement)
        {
            if (MetaobjectMapper != null && MetaobjectMapper.Contains(modelElement.Id))
                MetaobjectMapper.Remove(modelElement.Id);
        }
        ...
        public static MetaDataRepository.MetaObject FindMetaObjectFor(Microsoft.VisualStudio.Modeling.ModelElement modelElement)
        {
            ...
            if (MetaobjectMapper.Contains(identity))
            {
                MetaDataRepository.MetaObject metaObject = (MetaDataRepository.MetaObject)MetaobjectMapper[identity];
                ...
                if (metaObject is Class || metaObject is Structure)
                {
                    ...
                    if (stereotype != null)
                    {
                        ...
                        {
                            MetaobjectMapper.Remove(identity);
                            return null;
                        }
