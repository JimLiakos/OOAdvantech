...
namespace OOAdvantech.VSUMLMetaDataRepository
{
    ...
    public class AttributePresentationObject : PresentationObject<MetaDataRepository.StructuralFeature>
    {
        ...
        MetaDataRepository.StructuralFeature Attribute;
            ...
            get
            {
                if (Attribute.Persistent && string.IsNullOrWhiteSpace(BackwardCompatibilityID))
                {
                    if (Attribute is Attribute)
                        (Attribute as Attribute).GenerateBackwardCompatibilityID();
                    if (Attribute is AttributeRealization)
                        (Attribute as AttributeRealization).GenerateBackwardCompatibilityID();
                }
        ...
        public String ImplementetionField
        {
            get
            {
                ...
                return (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "ImplementetionField");
            }
            set
            {
                if (value != "Auto Generate")
                {
                    (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "ImplementetionField", value);
                    RefreshPersistentMember();
                }
            }
        }
        ...
        public string Type
        {
            ...
            set
            {
                ...
                MetaDataRepository.Classifier type = (from classifier in (Attribute as IVSUMLModelItemWrapper).UMLModel.GetTypes()
                                                            where classifier.FullName == value
                                                            select classifier).FirstOrDefault();
                if (type == null)
                {
                    type = (from primitive in (Attribute as IVSUMLModelItemWrapper).UMLModel.GetTypes().OfType<Primitive>()
                    ...
                    if (type == null)
                    {
                        IPrimitiveType primitiveType = (Attribute as IVSUMLModelItemWrapper).UMLModel.CreatePrimitiveType();
                        (primitiveType as ModelElement).GetExtensionData().SetPropertyValue("UnspecifiedType", true.ToString());
                        primitiveType.Name = value;
                        type = VisualStudioUMLHelper.GetClassifierFor(primitiveType, (Attribute as IVSUMLModelItemWrapper).UMLModel);
                    }
        ...
        public System.Collections.Generic.List<string> Types
        {
            get
            {
                ...
                foreach (var classifier in (Attribute as IVSUMLModelItemWrapper) .UMLModel.GetTypes())
                {
        ...
        public string BackwardCompatibilityID
        {
            ...
            get
            {
                return (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "Identity");
            }
            set
            {

                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "Identity", value);
                RealObject.PutPropertyValue("MetaData", "BackwardCompatibilityID", (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "Identity"));
            }
        ...
        public uint NextMemberID
        {
            get
            {
                string lastMemberID = (Attribute.GetVSUmlAttribute().Owner as ModelElement).GetExtensionData().GetPropertyValue("MetaData", "LastMemberID");
            ...
            set
            {
                (Attribute.GetVSUmlAttribute().Owner as ModelElement).GetExtensionData().SetPropertyValue("MetaData", "LastMemberID", value.ToString());
            }
        }
        ...
        public bool AutoGenerate
        {
            get
            {
                string autoGen = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "AutoGenerate");
            ...
            set
            {
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "AutoGenerate", value.ToString());
                RefreshPersistentMember();
                if (ObjectChangeState != null)
                {
        ...
        public bool HasBody
        {
            get
            {
                ...
                string hasBody = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "PropertyHasBody");
            ...
            set
            {
                ...
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "PropertyHasBody", value.ToString());
            }
        }
        ...
        public PropertyMethodKind GetPropertyMethod
        {
            get
            {
                string getterVisibility = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "GetterVisibility");
            ...
            set
            {
                ...
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "GetterVisibility", ((int)value).ToString());
        ...
        public PropertyMethodKind SetPropertyMethod
        {
            get
            {
                string setterVisibility = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "SetterVisibility");
            ...
            set
            {
                ...
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "SetterVisibility", ((int)value).ToString());
                if (value == PropertyMethodKind.None)
        ...
        public bool IsEvent
        {
            get
            {
                ...
                string propertyValue = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "AsEvent");
                bool value = false;
            ...
            set
            {
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "AsEvent", value.ToString());
        ...
        public bool IsProperty
        {
            get
            {
                ...
                string propertyValue = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "AsProperty");
                bool value = false;
                if (bool.TryParse(propertyValue, out value))
                    return value;
                else
            ...
            set
            {
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "AsProperty", value.ToString());
        ...
        public bool IsAbstract
        {
            get
            {
                string propertyValue = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "Abstract");
                bool value = false;
                if (bool.TryParse(propertyValue, out value))
                    return value;
                else
            ...
            set
            {
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "Abstract", value.ToString());
        ...
        public bool IsVirtual
        {
            get
            {
                string propertyValue = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "Virtual");
                bool value = false;
                if (bool.TryParse(propertyValue, out value))
                    return value;
                else
            ...
            set
            {
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "Virtual", value.ToString());
        ...
        public bool IsOverride
        {
            get
            {
                string propertyValue = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "Override");
                bool value = false;
                if (bool.TryParse(propertyValue, out value))
                    return value;
                else
            ...
            set
            {
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "Override", value.ToString());
        ...
        public bool IsNew
        {
            get
            {
                string propertyValue = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "New");
                bool value = false;
                if (bool.TryParse(propertyValue, out value))
                    return value;
                else
            ...
            set
            {
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "New", value.ToString());
        ...
        public bool IsSealed
        {
            get
            {
                string propertyValue = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "Sealed");
                bool value = false;
                if (bool.TryParse(propertyValue, out value))
                    return value;
                else
            ...
            set
            {
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "Sealed", value.ToString());
        ...
        public bool IsStatic
        {
            get
            {
                string propertyValue = (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().GetPropertyValue("MetaData", "Static");
                bool value = false;
                if (bool.TryParse(propertyValue, out value))
                    return value;
                else
            ...
            set
            {
                (Attribute as IVSUMLModelItemWrapper).ModelElement.GetExtensionData().SetPropertyValue("MetaData", "Static", value.ToString());
