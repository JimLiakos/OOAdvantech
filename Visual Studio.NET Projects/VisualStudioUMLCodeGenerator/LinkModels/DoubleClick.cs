...
namespace UmlElementLink
{
  ...
  partial class GestureExtension : UmlElementLinkCommand
  {
      ...
      /// <MetaDataID>{d5664bf2-70d7-4d6d-9569-27986601585e}</MetaDataID>
  ...
  abstract partial class UmlElementLinkCommand
  {
      ...
      /// <MetaDataID>{86eb90e7-bff0-481b-87b6-2562f920cda4}</MetaDataID>
    ...
    /// <MetaDataID>{cc12e70e-bb6d-431a-a648-9af247371cb5}</MetaDataID>
    ...
    /// <returns></returns>
    /// <MetaDataID>{a8dddac0-fb7d-446b-8eec-ccee8280b747}</MetaDataID>
