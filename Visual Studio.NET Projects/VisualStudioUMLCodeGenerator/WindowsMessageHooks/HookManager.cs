...
namespace WindowsMessageHooks
{
    ...
    public static partial class HookManager
    {
        ...
        /// <MetaDataID>{82d5a74c-7176-4cde-afad-2e9dc76a63bc}</MetaDataID>
        private static MouseButtons s_PrevClickedButton;
        //The timer to monitor time interval between two clicks.
        /// <MetaDataID>{b4408867-fc8d-4f17-bbec-097b01500820}</MetaDataID>
        private static Timer s_DoubleClickTimer;

        /// <MetaDataID>{31ebdbb6-3c11-44c1-bd3e-45eb5caa7b7a}</MetaDataID>
        ...
        /// <MetaDataID>{64875a15-30e3-4df6-81c5-3d48879a775b}</MetaDataID>
