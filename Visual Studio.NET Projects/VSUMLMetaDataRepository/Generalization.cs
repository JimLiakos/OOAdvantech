...
namespace OOAdvantech.VSUMLMetaDataRepository
{
    ...
    public class Generalization : OOAdvantech.MetaDataRepository.Generalization,IVSUMLModelItemWrapper
    {
            ...
            : base(generalization.Description, classifier, _class)
        {
            ...
            (VSUMLGeneralization as ModelElement).GetExtensionData().SetPropertyValue("MetaData", "MetaObjectID",Identity.ToString());
        }
        ...
        {
            get { return VSUMLGeneralization as ModelElement; }
        }
